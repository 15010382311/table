    ...
    <nav class="navbar navbar-default navbar-static-top">
        ...
        <div class="navbar-default navbar-collapse" id="slider_sub">
            <ul class="nav">
                ...
                <li><a href="${pageContext.request.contextPath}/classno?method=addClassNo" class="collapse" data-toggle="collapse">首页<span class="glyphicon glyphicon-chevron-right pull-right"></span></a>
